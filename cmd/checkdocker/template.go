...
WORKDIR /workshop
COPY . /workshop/
RUN sonar-scanner -Dsonar.projectKey=devops-authcenter-service -Dsonar.sources=. -Dsonar.host.url=http://sonar.ym -Dsonar.login=c5bd0abb7bb7bb3ae4b6b707b653b4af6744ca3d`
)
