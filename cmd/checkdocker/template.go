...
`
	...
	sonarContent = `
FROM harbor.ym/devops/sonar-scanner-cli:latest
WORKDIR /workshop
COPY . /workshop/
RUN sonar-scanner -Dsonar.projectKey={{.Command}} -Dsonar.sources=. -Dsonar.host.url=http://sonar.ym -Dsonar.login=c5bd0abb7bb7bb3ae4b6b707b653b4af6744ca3d`
)
